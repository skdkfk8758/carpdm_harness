---
name: harness-plan-gate
description: 인터뷰 + SPARC 프로세스로 계획 수립. "계획", "플래닝", "plan", "plan-gate", "인터뷰"를 요청할 때 사용합니다.
---
...
`docs/templates/plan-template.md` 템플릿을 참고하여 인터뷰 결과를 반영한 `.agent/plan.md` 초안을 작성한다:
...
1. `.agent/todo.md`도 함께 초안을 작성한다 (`docs/templates/todo-template.md` 기반).
2. `.agent/context.md`도 초기화한다 (`docs/templates/context-template.md` 기반).
...
- **대규모 변경 감지**: 변경 파일 5개 이상 또는 새 모듈/도메인 생성 시, `docs/templates/sdd-template.md` 기반의 상세 설계서(SDD) 작성을 권장한다.
